...
lyr_Renamed_0.set('fieldAliases', {'fid': 'fid', 'المنطقة': 'المنطقة', 'متوسط الحراره الكبرى ': 'متوسط الحراره الكبرى ', 'متوسط كميات الامطار ': 'متوسط كميات الامطار ', 'متوسط الحراره الصغرى ': 'متوسط الحراره الصغرى ', });
lyr_Renamed_0.set('fieldImages', {'fid': 'TextEdit', 'المنطقة': 'TextEdit', 'متوسط الحراره الكبرى ': 'TextEdit', 'متوسط كميات الامطار ': 'TextEdit', 'متوسط الحراره الصغرى ': 'TextEdit', });
lyr_Renamed_0.set('fieldLabels', {'fid': 'inline label - visible with data', 'المنطقة': 'inline label - visible with data', 'متوسط الحراره الكبرى ': 'inline label - visible with data', 'متوسط كميات الامطار ': 'inline label - visible with data', 'متوسط الحراره الصغرى ': 'inline label - visible with data', });
